...
Employe e1 = new Employe(1, "Manish", 15000);
Employe e2 = new Employe(2, "Mahesh", 20000);
Employe e3 = new Employe(3, "Manoj", 21000);
Employe e4 = new Employe(4, "Mukesh", 18000);
Employe e5 = new Employe(5, "Madhu", 16000);
Employe e6 = new Employe(6, "Raju", 30000);
